  ...
  <div class="h-full flex flex-col bg-background">
    ...
    <div
      ...
      <div
        ...
        @click="openCreateSheet" :title="t('link.new')" style="--wails-draggable: no-drag">
    ...
    <!-- Edit/New Drawer -->
    <LinkEditor v-model:open="visible" :form="form" :can-submit="canSubmit" @save="saveLink" @close="closeSheet"
